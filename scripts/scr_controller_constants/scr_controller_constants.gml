...
#macro CHARACTERNAME1	 (global.player1_char==0)?"Mikey":"Gavein"
#macro CHARACTERNAME2	 (global.player2_char==0)?"Mikey":"Gavein"
...
#macro K_JUMP_KICK	(myPlayer ==PLAYER0)?ord("Z"):vk_numpad1
#macro K_CROUCH		(myPlayer ==PLAYER0)?ord("S"):vk_down
#macro K_SPECIAL_PRE (myPlayer ==PLAYER0)?ord("F"):vk_numpad5
#macro K_LOW_KICK	(myPlayer ==PLAYER0)?ord("E"):vk_numpad7
#macro K_SPECIAL_ATTACK (myPlayer ==PLAYER0)?ord("C"):vk_numpad3

#macro C_CONTROLLER			(myPlayer == PLAYER0)?0:1
#macro C_RIGHT_PRESSED		(myPlayer == PLAYER0)?gamepad_button_check(0,gp_padr):gamepad_button_check(1,gp_padr)
#macro C_LEFT_PRESSED		(myPlayer == PLAYER0)?gamepad_button_check(0,gp_padl):gamepad_button_check(1,gp_padl)
